...
#define LCD_RST_LOW()           PORT->PCLRA =  (1<<2)
#define LCD_DC_HIGH()           PORT->PSETD = (1<<0)
#define LCD_DC_LOW()            PORT->PCLRD =  (1<<0)
#define LCD_WR_HIGH()           PORT->PSETC = (1<<11)
#define LCD_WR_LOW()            PORT->PCLRC =  (1<<11)
