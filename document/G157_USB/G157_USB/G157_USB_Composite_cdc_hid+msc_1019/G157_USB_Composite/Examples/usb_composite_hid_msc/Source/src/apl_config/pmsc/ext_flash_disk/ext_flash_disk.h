...
//W25Q128JV  4K per sector, page size =256Byte
#define STRG_FLASH_PAGESIZE             (0x100ul)              /* Flash Page Size: 256Byte*/
#define STRG_FLASH_SECTOR_SIZE          (0x1000ul)              /* Flash Sector Size: 4096Byte*/
#define STRG_MEDIASIZE                  (0x1000ul * STRG_FLASH_SECTOR_SIZE)       /* Media size */
#define STRG_TOTALSECT                  (STRG_MEDIASIZE / STRG_FLASH_SECTOR_SIZE)
#define FLASH_ID              		  		(0x40EF) 
...
extern usb_media_driver_t g_ext_flash_mediadriver;
