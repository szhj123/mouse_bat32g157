...
volatile uint32_t downloadmode,RxCount;
volatile uint32_t FlashStartAddress;
volatile uint8_t rx_data;
volatile uint8_t PacketNum,pNum;
volatile uint8_t RxBuff[2][128];
//volatile uint32_t spi21dmacount;
...
//					{
//						//Save to Flash
//						SpiFlash_PageProgram(FlashStartAddress, &RxBuff[0][0], 256);
//						FlashStartAddress += 256;
//					}
//					
//					pNum++;
//					SCI0->TXD0 = ACK;
