...
Pragma directive
***********************************************************************************************************************/
void IRQ27_Handler(void) __attribute__((alias("tm81_channel0_14_interrupt")));
void IRQ28_Handler(void) __attribute__((alias("tm81_channel1_15_interrupt")));
void IRQ29_Handler(void) __attribute__((alias("tm81_channel2_16_interrupt")));
void IRQ30_Handler(void) __attribute__((alias("tm81_channel3_17_interrupt")));
...
/***********************************************************************************************************************
* Function Name: tm81_channel0_14_interrupt
* @brief  This function INTTM10 or INTTM14 interrupt service routine.
* @param  None
* @return None
***********************************************************************************************************************/
static void tm81_channel0_14_interrupt(void)
{
...
/***********************************************************************************************************************
* Function Name: tm81_channel1_15_interrupt
* @brief  This function INTTM11 or INTTM15 interrupt service routine.
* @param  None
* @return None
***********************************************************************************************************************/
static void tm81_channel1_15_interrupt(void)
{
	  volatile uint8_t ifl, ifh;
    ifl = INTC_GetPendingIRQ(TM10_IRQn);
    ifh = INTC_GetPendingIRQ(TM14_IRQn);
...
/***********************************************************************************************************************
* Function Name: tm81_channel2_16_interrupt
* @brief  This function INTTM12 or INTTM16 interrupt service routine.
* @param  None
* @return None
***********************************************************************************************************************/
static void tm81_channel2_16_interrupt(void)
{
	  volatile uint8_t ifl, ifh;
    ifl = INTC_GetPendingIRQ(TM10_IRQn);
    ifh = INTC_GetPendingIRQ(TM14_IRQn);
...
/***********************************************************************************************************************
* Function Name: tm81_channel3_17_interrupt
* @brief  This function INTTM13 or INTTM17 interrupt service routine.
* @param  None
* @return None
***********************************************************************************************************************/
static void tm81_channel3_17_interrupt(void)
{
	  volatile uint8_t ifl, ifh;
    ifl = INTC_GetPendingIRQ(TM10_IRQn);
    ifh = INTC_GetPendingIRQ(TM14_IRQn);
