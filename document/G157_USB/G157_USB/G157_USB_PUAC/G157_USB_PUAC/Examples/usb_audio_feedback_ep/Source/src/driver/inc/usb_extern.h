...
extern uint16_t  usb_cstd_get_pid (uint16_t pipe);
    ...
    extern void        usb_puac_read_complete(usb_putr_t *p_mess, uint16_t data1, uint16_t data2);
    extern void        usb_puac_write_complete(usb_putr_t *p_mess, uint16_t data1, uint16_t data2);
