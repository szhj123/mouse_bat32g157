...
//			#define     CD_LEN      (0xC2)    /* Configuration Descriptor Length */
			#define     CD_LEN      (0xC9)    /* Configuration Descriptor Length */		//laidi add feedback endpoint
//#endif
__align(4) const uint8_t g_apl_configuration[] =
{
    ...
    0x00, 0x01,     /* bcdADC:1.0 */		//laidi TODO
...
//    0x0d,                       /* bmAttributes */
		0x02,	//laidi BULK ,pipe3(see usb_basic_define.h), not use!!!
    ...
    0x02,           /* bInterfaceNumber */
    0x01,           /* bAlternateSetting */
    0x02,           /* bNumEndpoints */			//laidi add a feedback endpoint
    0x01,           /* bInterfaceClass:AUDIO */
    0x02,           /* bInterfaceSubClass:AUDIOSTREAMING */
    0x00,           /* bInterfaceProtocol */
    0x00,           /* iInterface */
...
//    0x0d,                       /* bmAttributes */
		0x05,						/*laidi Attributes:0x05,Isochronous,Synchronization Type(Asynchronous)......... */
    EP3_MAX_PKT_SIZE, 0x00,     /* wMaxPacketSize */
    0x01,                       /* bInterval */
    0x03,                       /* bRefresh */		//0x00 laidi feedback refresh time?
    0x81,                       /* bSynchAddress */		//laidi feedback endpoint address
    ...
    0x07, /* bLength */	//laidi
    0x05,         /* bDescriptorType */
    FEED_BACK_EP_NUM | EP_INPUT,
    0x01 | 0x04 | 0x10,                          /*  Types -
																															Transfer: ISOCHRONOUS
                                                              Sync: Async
                                                              Usage: Feedback EP   */
    0x03, /* wMaxPacketSize */		//laidi 4
    0x00, /* wMaxPacketSize */
    0x06, /* interval polling(2^x ms) */
//    0x05,   //control time?
//    0x00,
};
/************************************************************
 ...
 ************************************************************/
__align(4) const static uint8_t gs_apl_string4[] =
{
    22,                 /*  0:bLength */
    USB_DT_STRING,      /*  1:bDescriptorType */
