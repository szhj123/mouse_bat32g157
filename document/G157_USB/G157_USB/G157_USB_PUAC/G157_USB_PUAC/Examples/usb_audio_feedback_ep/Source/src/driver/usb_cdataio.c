...
#if defined(USB_CFG_PUAC_USE)
    #include "usb_puac_mini_if.h"
#endif /* defined(USB_CFG_PUAC_USE) */
...
const uint8_t g_usb_pstd_pipe_no_tbl[] =
{
    ...
    USB_NULL,               USB_NULL,
		...
		#if defined(USB_CFG_PUAC_USE)
    USB_CFG_PUAC_ISO_OUT,   USB_CFG_PUAC_ISO_IN,    /* USB_PUAC */
    #else
    USB_NULL,               USB_NULL,
    #endif
};
...
void (*gp_usb_pstd_callback[]) (usb_putr_t *, uint16_t, uint16_t) =
{
    ...
    USB_NULL, USB_NULL, /* USB_PHID (2) */
		...
		/* PUAC */
    #if defined(USB_CFG_PUAC_USE)
    usb_puac_read_complete, usb_puac_write_complete, /* USB_PUAC (3) */
    #else
    USB_NULL, USB_NULL, /* USB_PUAC (3) */
    #endif
		
    /* PVNDR */
    USB_NULL, USB_NULL, /* USB_PVND  (4) */
    /* HCDC, HCDCC */
    USB_NULL, USB_NULL, /* USB_HCDC  (5) */
    USB_NULL, USB_NULL, /* USB_HCDCC (6) */
    /* HHID */
    USB_NULL, USB_NULL, /* USB_HHID  (7) */
    /* HVNDR */
    USB_NULL, USB_NULL, /* USB_HVND  (8) */
    /* HMSC */
    USB_NULL, USB_NULL, /* USB_HMSC  (9) */
    /* PMSC */
    USB_NULL, USB_NULL, /* USB_PMSC  (10) */
