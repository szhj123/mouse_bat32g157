...
uint32_t uaccount;
uint8_t iistxbuff[4][512],iisrxbuff[256];
...
//								if(iisdmacount&0x01)
//								{
//									USB_PipeRead(&Ctrl, (uint8_t *)&iistxbuff[0][0], EP3_MAX_PKT_SIZE);
//								}
//								else
//								{
//									USB_PipeRead(&Ctrl, (uint8_t *)&iistxbuff[1][0], EP3_MAX_PKT_SIZE);
//								}
                ...
                break;
						...
						case USB_STS_READ_COMPLETE :
								...
								switch(iisdmacount)
								{
									...
									break;
									case 0:
										USB_PipeRead(&Ctrl, (uint8_t *)&iistxbuff[2][0], EP3_MAX_PKT_SIZE);
									break;
									case 1:
										USB_PipeRead(&Ctrl, (uint8_t *)&iistxbuff[3][0], EP3_MAX_PKT_SIZE);
									break;
								...
								{
									case 2:
										DMA_Start(DMA_VECTOR_ST0, UART0_TX_DMA_CHANNEL, DMA_MODE_NORMAL, DMA_SIZE_BYTE, EP3_MAX_PKT_SIZE, (uint8_t *)&iistxbuff[3][0], (uint8_t *)&SCI0->TXD0);
										DMA_Enable(DMA_VECTOR_ST0);
									break;
									case 3:
										DMA_Start(DMA_VECTOR_ST0, UART0_TX_DMA_CHANNEL, DMA_MODE_NORMAL, DMA_SIZE_BYTE, EP3_MAX_PKT_SIZE, (uint8_t *)&iistxbuff[0][0], (uint8_t *)&SCI0->TXD0);
										DMA_Enable(DMA_VECTOR_ST0);
									break;
									case 0:
										DMA_Start(DMA_VECTOR_ST0, UART0_TX_DMA_CHANNEL, DMA_MODE_NORMAL, DMA_SIZE_BYTE, EP3_MAX_PKT_SIZE, (uint8_t *)&iistxbuff[1][0], (uint8_t *)&SCI0->TXD0);
										DMA_Enable(DMA_VECTOR_ST0);
									break;
									case 1:
										DMA_Start(DMA_VECTOR_ST0, UART0_TX_DMA_CHANNEL, DMA_MODE_NORMAL, DMA_SIZE_BYTE, EP3_MAX_PKT_SIZE, (uint8_t *)&iistxbuff[2][0], (uint8_t *)&SCI0->TXD0);
										DMA_Enable(DMA_VECTOR_ST0);
									break;
