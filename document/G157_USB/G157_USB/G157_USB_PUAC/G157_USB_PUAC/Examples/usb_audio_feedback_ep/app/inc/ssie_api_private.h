...
*******************************************************************************/
/******************************************************************************
* File Name    : ssie_api_private.h
* Version      : 2.00
* Description  : SSIE driver module file for BAT MCUs.
*******************************************************************************
...
/******************************************************************************
  Operands and values just used for functions in ssi_api_rx.c.
******************************************************************************/
...
#define SSIE_SSICR_IIEN_DISABLE      (0u)
#define SSIE_SSICR_IIEN_ENABLE       (1u)
...
/******************************************************************************
    ...
    "Standarad configuration" 
       ...
       "Standard configuration" described in "ssi_api_rx_config.h".
...
/*********************************************************
    SSIEn.SSICR.CKS calculation
*********************************************************/
/*  SSIEn_CKS are chosen correspnding to
      SSIEn_CLK_CKS value.
*/
/************************
*      Channel 0        *
************************/
#if (SSIE_CH0_CLK_CKS == 0u)
    /* AUDIO_CLK input */
    #define SSIE_CH0_CKS         (0u)
#elif (SSIE_CH0_CLK_CKS == 1u) 
    /* Timer output */
    #define SSIE_CH0_CKS         (1u)
#else 
    /* case error */
    #define SSIE_CH0_CKS         (0xFFFFFFFFu)
#endif
                            
/************************
*      Channel 1        *
************************/
#if (SSIE_CH1_CLK_CKS == 0u)
    /* AUDIO_CLK input */
    #define SSIE_CH1_CKS         (0u)
#elif (SSIE_CH1_CLK_CKS == 1u) 
    /* Timer output */
    #define SSIE_CH1_CKS         (1u)
#else 
    /* case error */
    #define SSIE_CH1_CKS         (0xFFFFFFFFu)
#endif
...
************************/
#if ((SSIE_CH0_SERIAL_IF_FMT == 0u) || (SSIE_CH0_SERIAL_IF_FMT == 1u) || (SSIE_CH0_SERIAL_IF_FMT == 2u))
    #define SSIE_CH0_TDES        (SSIE_CH0_TDES_NUMBER - 1u)
#else
    #define SSIE_CH0_TDES        (0xFFFFFFFFu)
#endif

#if ((SSIE_CH0_TDES < 0u) || (SSIE_CH0_TDES >= 8u))
    #define SSIE_CH0_TDES        (0xFFFFFFFFu)
#endif
...
************************/
#if ((SSIE_CH1_SERIAL_IF_FMT == 0u) || (SSIE_CH1_SERIAL_IF_FMT == 1u) || (SSIE_CH1_SERIAL_IF_FMT == 2u))
    #define SSIE_CH1_TDES        (SSIE_CH0_TDES_NUMBER - 1u)
#else
    #define SSIE_CH1_TDES        (0xFFFFFFFFu)
#endif

#if ((SSIE_CH1_TDES < 0u) || (SSIE_CH1_TDES >= 8u))
    #define SSIE_CH1_TDES        (0xFFFFFFFFu)
#endif
