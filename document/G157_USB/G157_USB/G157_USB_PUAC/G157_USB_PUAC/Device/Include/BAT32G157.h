...
typedef struct {                                /*!< (@ 0x40042180) TM81 Structure                                             */
  ...
  __IOM uint16_t  TDR12;                        /*!< (@ 0x0000019C) Timer data register 02                                     */
  __IOM uint16_t  TDR13;                        /*!< (@ 0x0000019E) Timer data register 03                                     */
  __IOM uint16_t  TDR14;                        /*!< (@ 0x000001A0) Timer data register 04                                     */
  __IOM uint16_t  TDR15;                        /*!< (@ 0x000001A2) Timer data register 05                                     */
  __IOM uint16_t  TDR16;                        /*!< (@ 0x000001A4) Timer data register 06                                     */
  __IOM uint16_t  TDR17;                        /*!< (@ 0x000001A6) Timer data register 07                                     */
} TM81_Type;                                    /*!< Size = 424 (0x1a8)                                                        */
...
typedef struct {                                /*!< (@ 0x0850084C) UID Structure                                              */
